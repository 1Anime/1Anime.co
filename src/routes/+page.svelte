	...
	<div class="features">
		<div class="left">
			<div class="open-source">
				<div class="type--group-heading-and-content">
					<h2>Free & Ad-Free</h2>
					<h3 style="display: flex">— all thanks to YOU & our <Button type="link-heading" urlTarget="_blank" url="https://1anime.info/community/"><IconArrowDownLeft class="external-link" size={20} stroke={1.5} /> Community</Button></h3>
